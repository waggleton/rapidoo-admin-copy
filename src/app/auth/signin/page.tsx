...
import Breadcrumb from "@/components/Breadcrumbs/Breadcrumb_no_dashboard";
import { Metadata } from "next";
import { AttemptLogIn } from "@/components/Api/admin";
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            ...
            {alertVisible && <Alert_Error text={"Incorrect username or password "} />}
              ...
              {/* Add similar code for the password field */}
              <div className="mb-4">
                <label className="mb-2.5 block font-medium text-black dark:text-white">
                  Password
                </label>
