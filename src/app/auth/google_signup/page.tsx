...
import { AttemptRegister } from "@/components/Api/admin";
import { useSearchParams } from 'next/navigation';

import ShowPasswordButton from "@/components/button/show_password";
...
const GoogleSignUp: React.FC = () => {
  ...
  const [confirmMatchPasswordRequired, setMatchPasswordRequired] = useState(false);
  ...
  useEffect(() => {
      ...
      setName(searchParams.get('user') as string);
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                ...
                {showRegisteredAlert && <Alert_Error text={"Name or Email already registered"} />}
              </h2>
              ...
              <div>
                ...
                <div className="mb-4">
                  ...
                  {passwordStrong && (
                   <div> <span className="text-red-500 text-sm mt-1">This password is weak</span></div>
                  )}
                ...
                <div className="mb-6">
                  ...
                  {confirmMatchPasswordRequired && (
                    <span className="text-red-500 text-sm mt-1">The passwords do not match</span>
                  )}
                </div>
                </div>
                <div className="mb-5">
                  <input
                    onClick={() => AttemptRegister(setNameRequired, setEmailRequired, setPasswordRequired, setPasswordStrong, setConfirmPasswordRequired, setMatchPasswordRequired, setShowRegisteredAlert, nameRequired, emailRequired, passwordRequired, confirmPasswordRequired, confirmMatchPasswordRequired, email, name, firstPassword, matchPassword)}
                    type="submit"
